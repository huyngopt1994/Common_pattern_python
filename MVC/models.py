...
class Url(object):
    ...
    def shorten(cls, full_url):
        ...
        #call method instance of instance
    ...
    def __create_short_url(self):
        """Create short url, save it and return it."""
        last_short_url = Url.__load_last_short_url()
        print(last_short_url)
    ...
    def __load_url_mapping():
        """Return short_url to Url instance mapping."""
        try:
